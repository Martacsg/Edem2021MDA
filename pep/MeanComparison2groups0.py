# -*- coding: utf-8 -*-
"""
Created on Fri Nov 19 17:39:09 2021
...
# Subsetting
cnt_wd=wbr.loc[(wbr['workingday'] == 1), 'cnt'] # grupo 1, 'cnt'= variable cuantitativa a testear
cnt_nwd=wbr.loc[(wbr['workingday'] == 0), 'cnt'] # grupo 2
...
plt.ylim(2800,6200) #rango entre 0 y 9.000
