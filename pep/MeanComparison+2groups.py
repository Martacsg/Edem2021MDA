# -*- coding: utf-8 -*-
"""
Created on Fri Nov 19 19:11:57 2021
...
bar_list = ['1: Sunny', '2: Cloudy', '3: Rainy']
...
# Subsetting
cnt_sunny=wbr.loc[(wbr['weathersit'] == 1), 'cnt'] # grupo 1, 'cnt'= variable cuantitativa a testear
cnt_cloudy=wbr.loc[(wbr['weathersit'] == 2), 'cnt'] # grupo 2
cnt_rainy=wbr.loc[(wbr['weathersit'] == 3), 'cnt'] # grupo 2
...
ax = sns.pointplot(x="weathersit", y="cnt", data=wbr,ci=99, join=0)
...
plt.title('Figure 6. Average rentals by Weathersit.''\n')
